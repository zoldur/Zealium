...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='zealium.conf'
CONFIGFOLDER='/root/.zealium'
COIN_DAEMON='zealiumd'
COIN_CLI='zealium-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/zealiumcoin/Zealium/releases/download/v1.0.0.0/Zealium-v1.0.0.0-linux64.tar.gz'
